 ...
 * @author Rameesha
 */
public class departmentoverview extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("DEPARTMENT OVERVIEW");
        ...
        jLabel4.setText("View Department Employees");
        jLabel4.setOpaque(true);

        jLabel16.setFont(new java.awt.Font("Myriad Arabic", 1, 14)); // NOI18N
        jLabel16.setText("Department");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Finance", "Marketing", "HR", "Dispatch", "Security", "Audit" }));
